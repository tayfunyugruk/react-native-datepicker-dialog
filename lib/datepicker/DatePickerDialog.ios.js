          ...
          <View style={styles.background}>
		    ...
		    locale={locale ? locale : 'en_EN'}
                  ...
                  <View style={{flexDirection: 'row', paddingTop: 20}}>
                    <TouchableHighlight style={{flex:1, padding: 5}} onPress={this.cancel.bind(this)} underlayColor={"#57D4E8"}>
                      <View style={{}}><Text style={styles.buttonTextStyle}>{this.props.cancelLabel}</Text></View>
                    </TouchableHighlight>
                    <TouchableHighlight style={{flex:1, padding: 5}} onPress={this.ok.bind(this)} underlayColor={"#57D4E8"}>
